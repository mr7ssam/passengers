...
import 'package:shop_app/features/user/presentation/pages/complete_info/steps/step_one_provider.dart';
import 'package:shop_app/features/user/presentation/pages/complete_info/steps/step_two_provider.dart';
    ...
    on<CompleteInformationEvent>((event, emit) async {
      if (event is CompleteInformationSubmitted) {
        ...
        result.when(
          ...
          failure: (message) => emit(CompleteInformationFailure(message)),
        );
      }
    });
  }
